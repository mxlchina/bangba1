package com.bangba.chat.util.email;
...
public class EmailUtil {
		...
		public static void sendMessage(String smtpHost, String from,
			...
			transport.connect(smtpHost,"mxlchina@163.com", fromUserPassword);
		...
		public static void main(String[] args) {
			try {
				EmailUtil.sendMessage("smtp.163.com", "mxlchina@163.com",
						"lizhifang1", "mxlchina@163.com", "nihao",
						"---------------wrwe-----------",
